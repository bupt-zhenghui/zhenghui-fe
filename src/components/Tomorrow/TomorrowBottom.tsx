  ...
  render() {
    return (
      <Card className={styles.customCard}>
        ...
        <Paragraph>大概从高中那会儿开始，自己的性格慢慢地变得孤僻，也不知道是课业压力重了还是什么其他的原因，潜移默化。一直以来，不管做什么事情都更喜欢一个人单打独斗。一个人学习，一个人吃饭，一个人上下课，早已习惯。喜欢羽毛球、乒乓球这种强调个人能力的运动；打游戏喜欢玩单人线，对线能力可以，支援能力很差；大学里很擅长考试（理科），但只要是小组作业，我大概率拖后腿。四年的生活充实，却极其平淡，毫无波澜，大一到大四都是一个节奏，木头人一般。</Paragraph>
