          ...
          <Row align={"middle"} style={{backgroundColor:"transparent"}}>
            ...
            <Col span={8} offset={1}>
              <Typography>
                ...
                <Title level={5} style={{marginTop: 0}}>学历：研究生（在读）</Title>
                <Title level={5} style={{marginTop: 0}}>所在单位：北京邮电大学</Title>
                <Title level={5} style={{marginTop: 0}}>地址：北京市海淀区西土城路10号</Title>
        ...
        <Card style={{marginBottom:20}}>
          <Row align={"middle"} style={{backgroundColor:"transparent"}}>
            <Col span={13} offset={4}>
              <Typography>
                <Paragraph>
                  北京邮电大学人工智能学院研究生、前北邮叶培大实验班学生，校级三好学生，校优秀本科毕业生。研究方向：计算机视觉，后端研发。本科三年陆续获得校级、
          ...
          <Row align={"middle"} style={{backgroundColor:"transparent"}}>
            <Col span={13} offset={4}>
              <Typography>
                ...
                <EduExp src="/icons/bytedance.png" school="字节跳动" date="2021.03~2021.08"/>
                <EduExp src="/icons/bupt.png" school="北京邮电大学 电子信息" date="2021.09~2024.06"/>
              </Typography>
            </Col>
          </Row>
        </Card>
