...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<API.RuleListItem>[] = [
    ...
    {
      title: <FormattedMessage id="pages.searchTable.titleCallNo" defaultMessage="题目难度" />,
      dataIndex: 'callNo',
      sorter: true,
      hideInForm: true,
    },
    {
      ...
      valueEnum: {
        0: {
          text: (
            <FormattedMessage id="pages.searchTable.nameStatus.default" defaultMessage="未做" />
          ),
          status: 'Default',
        },
        1: {
          text: (
            <FormattedMessage id="pages.searchTable.nameStatus.running" defaultMessage="未通过" />
          ),
          status: 'Processing',
        },
        2: {
          text: (
            <FormattedMessage id="pages.searchTable.nameStatus.online" defaultMessage="通过" />
          ),
          status: 'Success',
        },
        3: {
